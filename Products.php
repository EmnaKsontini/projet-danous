        ...
        <div id="left">
            ...
            <ul>
                ...
                echo ("
                 <li>
                     <div class=\"img\">
                        <a href=\"product.php?ref=".$el->Reference."&amp;table=".$table."\">
                        <img src=\"images\\".$el->Reference.".jpg\" alt=\"".$el->Reference."\" style=\"width:128px;height:128px;\">
                        </a>
                    </div>
                     <div class=\"info\">
                    <a class=\"title\" href=\"product.php?ref=".$el->Reference."&amp;table=".$table."\">".$el->Reference."</a>
                         <p>on va ecire une description ici1</p>
                         <div class=\"price\">
                        <span class=\"st\">Our price:</span><strong>".$el->Prix." DT</strong>
                         </div>
                             <div class=\"actions\">
                                 <a href=\"product.php?ref=".$el->Reference."&amp;table=".$table."\">Details</a>
